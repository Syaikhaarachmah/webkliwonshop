  ...
  <?php $tr = $dtransaksi->row_array(); ?>
            ...
            <div class="row">
              <div class="col-lg-6 col-sm-6">
                <div class="invoice-info"> <img src="<?php echo base_url(); ?>assets_admin/images/logo-login-admin.png" alt="">
                  <h3>Subject: <span><?php echo $title; ?> </span></h3>
                <h4>invoice info</h4>
                <ul class="some-about">
                  <li><span>date:</span><?php echo date('d-m-Y', strtotime($tr['transaksi_tgl_pesan'])); ?></li>
                  <li><span>date due:</span><?php echo date('d-m-Y', strtotime($tr['transaksi_bts_bayar'])); ?></li>
