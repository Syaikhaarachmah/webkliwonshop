    ...
    <div class="element-title">
      ...
      <div class="add-prod-from">
        <div class="row">
          <div class="col-md-12">
            <label>Teks 1</label>
            <input type="text" name="teks1" value="<?php echo set_value('teks1'); ?>" placeholder="Women fashion">
            <small class="text-danger"><?php echo form_error('teks1'); ?></small>
          </div>
          <div class="col-md-12">
            <label>Teks 2</label>
            <input type="text" name="teks2" value="<?php echo set_value('teks2'); ?>" placeholder="popular style">
            <small class="text-danger"><?php echo form_error('teks2'); ?></small>
          </div>
          <div class="col-md-12">
            <label>Teks 3</label>
            <input type="text" name="teks3" value="<?php echo set_value('teks3'); ?>" placeholder="Big Sale of This Week 50% off">
          ...
          <div class="col-md-12">
            <label>Urutan</label>
            <input type="text" name="urutan" value="<?php echo set_value('urutan'); ?>" placeholder="3">
