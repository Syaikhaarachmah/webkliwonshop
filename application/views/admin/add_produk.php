      ...
      <div class="add-prod-from">
        <div class="row">
          <div class="col-md-6">
            ...
            <input type="text" name="nama-produk" value="<?php echo set_value('nama-produk'); ?>" placeholder="Men's watch">
            <small class="text-danger"><?php echo form_error('nama-produk'); ?></small>
          </div>
          <div class="col-md-6">
            <label>Harga Produk</label>
            <input type="text" name="harga-produk" value="<?php echo set_value('harga-produk'); ?>" placeholder="80000">
            <small class="text-danger"><?php echo form_error('harga-produk'); ?></small>
          </div>
          <div class="col-md-6">
            <label>Stok</label>
            <input type="text" name="stok-produk" value="<?php echo set_value('stok-produk'); ?>" placeholder="10">
          ...
          <div class="col-md-6">
            ...
            <input type="text" id="txt1" name="kategori-produk" placeholder="baju, kaos">
          ...
          <div class="col-md-12">
            ...
            <textarea cols="30" name="deskripsi-produk" rows="10" placeholder="loram ipsum dolor sit amit"><?php echo set_value('deskripsi-produk'); ?></textarea>
