...
<head>
    ...
    <meta name="description" content="Blog ViloShop Online Shopping">
    <!-- Open Graph Meta-->
    <!-- <link rel="icon" href="<?php echo base_url(); ?>assets_beranda/favicon.ico"> -->
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="Blog ViloShop Online Shopping">
    <meta property="og:title" content="<?php echo $title; ?> - Blog ViloShop Online Shopping">
    <meta property="og:description" content="Blog ViloShop Online Shopping">
	<title><?php echo $detailblog['blog_judul']; ?> - Blog <?php echo $profil['profil_nama']; ?> Online Shopping</title>
								...
								<?php }else { ?>
									<li class="lan_area"><a href="#"><i class="fa fa-user"></i> <?php echo $this->session->userdata('username'); ?> <i class="fa fa-caret-down"></i></a>
										<ul class="csub-menu">
											...
											<li><a href="<?php echo base_url(); ?>user/komentar">Komentar</a></li>
				...
				<div class="container">
					<div class="row">		
						<div class="col-xs-12 col-sm-12 col-md-3"> 
							<a class="logo" href="<?php echo base_url(); ?>"> <img alt="" src="<?php echo base_url(); ?>assets_home/img/logo.png"></a> 
						</div><!--  End Col -->
