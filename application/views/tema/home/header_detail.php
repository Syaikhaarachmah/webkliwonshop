...
<head>
    ...
    <meta name="description" content="ViloShop Online Shopping">
    <!-- Open Graph Meta-->
    <!-- <link rel="icon" href="<?php echo base_url(); ?>assets_beranda/favicon.ico"> -->
    <meta property="og:type" content="website">
    <meta property="og:site_name" content="ViloShop Online Shopping">
    <meta property="og:title" content="<?php echo $title; ?> - ViloShop Online Shopping">
    <meta property="og:description" content="ViloShop Online Shopping">
	<title><?php echo $detail['produk_name']; ?> - <?php echo $profil['profil_nama']; ?> Online Shopping</title>
