			...
			<div class="ftr_btm_area">
				<div class="container">
					<div class="row">
						...
						<div class="col-sm-5">
							<p class="copyright_text text-center">&copy; <?php echo date('Y'); ?> All Rights Reserved <?php echo $profil['profil_nama']; ?>. Template by <a href="https://themesvila.com/" class="text-light">Themesvila</a></p>
						</div>
