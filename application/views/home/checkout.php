                    ...
                    <div class="col-md-6">
                        ...
                        <form class="checkout_form" action="" method="post">
                            ...
                            <div class="form-group">
								...
								<textarea rows="3" name="alamat" id="address" placeholder="Street address. Apartment, suite, unit etc. (optional)" class="form-control"></textarea>
								<small class="text-danger"><?php echo form_error('alamat'); ?></small>
                            </div>

                            <div class="form-group">
								<label for="address">Catatan tambahan:</label>    
								<textarea rows="3" name="note" placeholder="Order note" class="form-control"></textarea>                            
                            </div>
