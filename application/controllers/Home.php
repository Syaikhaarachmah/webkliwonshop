...
class Home extends CI_Controller {
	...
	public function index() {
		...
		$this->load->view('tema/home/blog');
		$this->load->view('tema/home/process');
		$this->load->view('tema/home/brand');
	...
	public function single($id,$tag,$url) {
		...
		$data['komentar'] = $this->Home_model->komentar_produk($id);
	...
	private function _sendemail($token) {
		...
		$config['smtp_user'] = 'email@gmail.com'; //email anda di sini
		$config['smtp_pass'] = 'password'; // password email anda di sini
		$config['crlf'] = "\r\n";
		$config['newline'] = "\r\n";
		...
		$this->email->from('email@gmail.com', 'ViloShop'); //email anda di sini
